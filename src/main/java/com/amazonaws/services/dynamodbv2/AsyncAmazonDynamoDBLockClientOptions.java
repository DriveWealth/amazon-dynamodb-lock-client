 ...
 */
public class AsyncAmazonDynamoDBLockClientOptions {
    ...
    public static class AmazonDynamoDBLockClientOptionsBuilder {
        ...
        AmazonDynamoDBLockClientOptionsBuilder(final DynamoDbAsyncClient dynamoDBClient, final String tableName) {
        ...
        AmazonDynamoDBLockClientOptionsBuilder(final DynamoDbAsyncClient dynamoDBClient, final String tableName, final String ownerName,
         ...
         */
        public AsyncAmazonDynamoDBLockClientOptions build() {
            ...
            return new AsyncAmazonDynamoDBLockClientOptions(this.dynamoDBClient, this.tableName, this.partitionKeyName, this.sortKeyName, this.ownerName, this.leaseDuration,
     ...
     */
    public static AmazonDynamoDBLockClientOptionsBuilder builder(final DynamoDbAsyncClient dynamoDBClient, final String tableName) {
        return new AmazonDynamoDBLockClientOptionsBuilder(dynamoDBClient, tableName);
    }

    private AsyncAmazonDynamoDBLockClientOptions(final DynamoDbAsyncClient dynamoDBClient, final String tableName, final String partitionKeyName, final Optional<String> sortKeyName,
