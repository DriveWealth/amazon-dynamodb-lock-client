 ...
 */
public class AsyncLockItem implements Closeable {
    private final AmazonAsyncDynamoDBLockClient client;
     ...
     *                                      the lock
     */
    AsyncLockItem(final AmazonAsyncDynamoDBLockClient client, final String partitionKey, final Optional<String> sortKey, final Optional<ByteBuffer> data, final boolean deleteLockItemOnClose,
    ...
    public boolean acquireWriteLock(long timeoutMs) throws InterruptedException {
    	return writeLock.tryLock(timeoutMs, TimeUnit.MILLISECONDS);
    }
    ...
    public boolean equals(final Object other) {
        if (other == null || !(other instanceof AsyncLockItem)) {
            return false;
        }

        final AsyncLockItem otherLockItem = (AsyncLockItem) other;
