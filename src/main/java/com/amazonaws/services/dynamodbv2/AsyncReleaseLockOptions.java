 ...
 */
public class AsyncReleaseLockOptions {
    private final AsyncLockItem lockItem;
    private final boolean deleteLock;
    private final boolean bestEffort;
    private final Optional<ByteBuffer> data;

    AsyncReleaseLockOptions(final AsyncLockItem lockItem, final boolean deleteLock, final boolean bestEffort, final Optional<ByteBuffer> data) {
    ...
    public static class ReleaseLockOptionsBuilder {
        ...
        ReleaseLockOptionsBuilder(final AsyncLockItem lockItem) {
            this.lockItem = lockItem;
        ...
        public AsyncReleaseLockOptions build() {
            return new AsyncReleaseLockOptions(this.lockItem, this.deleteLock, this.bestEffort, this.data);
        }
     ...
     */
    public static ReleaseLockOptionsBuilder builder(final AsyncLockItem lockItem) {
