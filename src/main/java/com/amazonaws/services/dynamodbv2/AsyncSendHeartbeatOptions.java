 ...
 */
public class AsyncSendHeartbeatOptions {
    private final AsyncLockItem lockItem;
    private final Optional<ByteBuffer> data;
    private final Boolean deleteData;
    private final Long leaseDurationToEnsure;
    private final TimeUnit timeUnit;

    private AsyncSendHeartbeatOptions(final AsyncLockItem lockItem, final Optional<ByteBuffer> data, final Boolean deleteData, final Long leaseDurationToEnsure, final TimeUnit timeUnit) {
    ...
    public static class SendHeartbeatOptionsBuilder {
        private AsyncLockItem lockItem;
        private Optional<ByteBuffer> data;
        private Boolean deleteData;
        private Long leaseDurationToEnsure;
        private TimeUnit timeUnit;

        SendHeartbeatOptionsBuilder(final AsyncLockItem lockItem) {
            this.lockItem = lockItem;
        ...
        public AsyncSendHeartbeatOptions build() {
            return new AsyncSendHeartbeatOptions(this.lockItem, this.data, this.deleteData, this.leaseDurationToEnsure, this.timeUnit);
        }
     ...
     */
    public static SendHeartbeatOptionsBuilder builder(final AsyncLockItem lockItem) {
        return new SendHeartbeatOptionsBuilder(lockItem);
    }

    AsyncLockItem getAsyncLockItem() {
